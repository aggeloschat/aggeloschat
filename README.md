...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&center=true&width=935&lines=System.out.println(%22Welcome+to+my+Github%22);sleep(),+eat(),+code(),+repeat().;def+life():+return+code+%2B+coffee;while(!succeed)+%7B+tryAgain()+%7DSimplicity+is+the+soul+of+efficiency.;Code+is+like+a+joke.+If+you+have+to+explain+it,+It's+bad.;" alt="Typing SVG" />
</p>
